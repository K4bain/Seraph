...
function LegendItem({
 ...
 flex: 1, display: "flex", flexDirection: "column", gap: "1px"
        ...
        >
          ...
          <span style={{
 fontSize: 10, fontFamily: "var(--font-mono)", color: "var(--text-muted)", letterSpacing: "0.02em"
}}
          >
            ...
            if (layerPlugin) {
                ...
                return (
                  <div style={{ padding: "var(--space-md)" }}>
                    <div style={{
 display: "flex", alignItems: "center", gap: "var(--space-sm)", marginBottom: "var(--space-md)"
}}
                    >
                      <PluginIcon icon={layerPlugin.plugin.icon} size={20} />
                      <span style={{ fontSize: 16, fontWeight: 600, color: "var(--text-primary)" }}>
                        {layerPlugin.plugin.name}
                        {' '}
                        Layer
                      </span>
                    </div>
                    <div style={{
 color: "var(--text-secondary)", fontSize: 13, marginBottom: "var(--space-lg)", lineHeight: 1.5
}}
                    >
        ...
        <div className="intel-panel__props">
          ...
          {selectedEntity.altitude !== undefined && (
            <div className="intel-panel__prop">
              ...
              <span className="intel-panel__prop-value">
                {selectedEntity.altitude.toFixed(0)}
                {' '}
                m
              </span>
            </div>
